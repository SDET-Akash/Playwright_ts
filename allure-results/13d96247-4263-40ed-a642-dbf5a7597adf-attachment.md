...
- Name: visualTesting.spec.js >> screenshot test
- Location: tests/visualTesting.spec.js:3:5
...
Error: expect(Buffer).toMatchSnapshot(expected) failed
  ...
  15580 pixels (ratio 0.02 of all image pixels) are different.
        ...
        - banner [ref=f1e3]:
          - generic [ref=f1e6]:
            - generic [ref=f1e7]:
              ...
              - generic [ref=f1e10]: 2d 11h 23m 56s
...
```ts
  ...
  2 | 
  3 | test("screenshot test",async({page})=>
  4 | {
  5 |     await page.goto("https://rahulshettyacademy.com/AutomationPractice/");
  6 |     // await page.screenshot({path:"screenshot.png",fullPage:true});
  7 | 
